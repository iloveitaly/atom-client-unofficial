...
from ...models.get_showtime_details_request import GetShowtimeDetailsRequest
...
def _get_kwargs(
    *,
    body: GetShowtimeDetailsRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/partner/v1/showtime/details/byIds",
    }
