...
class VenueShowtimeDetails:
    """
    Attributes:
        showtime_details (list[ShowtimeDetail] | Unset): List of showtime details for the venue
        pre_order_details (list[PreOrderDetail] | Unset): List of pre-order details for the venue
    """
